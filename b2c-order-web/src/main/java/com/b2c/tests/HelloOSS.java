...
public class HelloOSS {
    ...
    private static String firstKey = "my-first-key111";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "qq/IMG_0682.JPG";
            InputStream inputStreams = new FileInputStream("C://Users/mayn/Desktop/IMG_0682.JPG");
            ossClient.putObject(bucketName, fileKey, inputStreams);
